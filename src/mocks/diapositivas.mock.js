const diapositivas = [
    ...
    { title: "First, 10 push-ups", text: "Do 10 reps. Remenber about full range of motion. Don't rush." },
    { title: "Next, 20 squeats", text: "Squats are important. Remember to keep your back straight." },
